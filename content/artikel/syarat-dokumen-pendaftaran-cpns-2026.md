---
title: "Syarat & Dokumen Pendaftaran CPNS 2026: Checklist Lengkap"
description: "Syarat dan dokumen pendaftaran CPNS 2026: usia, pendidikan, KTP, ijazah, e-meterai, plus checklist cetak. Status resmi terbaru per September 2026."
date: 2026-09-01
slug: syarat-dokumen-pendaftaran-cpns-2026
---
...
| Ijazah | PDF | Sesuai kualifikasi formasi yang dilamar; scan berkas asli |
| Transkrip nilai | PDF | Scan berkas asli |
...
| Surat lamaran | PDF | Format sesuai ketentuan instansi, dibubuhi **e-meterai Rp10.000** |
| Surat pernyataan | PDF | Dibubuhi **e-meterai Rp10.000** |
...
1. **Buat akun** di sscasn.bkn.go.id — isi NIK, KK, dan data sesuai KTP, unggah scan KTP, lakukan swafoto, lalu cetak **Kartu Informasi Akun**.
2. **Login** dengan NIK dan password, lengkapi biodata.
3. **Pilih seleksi CPNS**, instansi, formasi, jabatan, dan lokasi tes — baca syarat khusus instansi terlebih dahulu.
4. **Unggah seluruh dokumen** sesuai format dan ukuran yang diminta.
5. **Cek resume dan preview** — pastikan semua benar.
6. **Akhiri Pendaftaran**, lalu cetak **Kartu Pendaftaran** sebagai bukti.
...
1. **Periksa data kependudukan** — pastikan nama, tempat/tanggal lahir di KTP, KK, dan ijazah konsisten. Perbedaan kecil sering jadi penyebab gagal verifikasi.
2. **Siapkan scan dokumen** — pindai dari berkas asli dengan kualitas baik, simpan dengan nama file yang jelas.
...
Belum. Per 1 September 2026, pemerintah belum mengumumkan pembukaan pendaftaran CPNS jalur umum 2026. Pantau sscasn.bkn.go.id dan kanal resmi BKN/MenPAN-RB.

**Di mana tempat mendaftar CPNS 2026?**
Hanya di portal resmi SSCASN BKN: [sscasn.bkn.go.id](https://sscasn.bkn.go.id). Waspadai situs atau tautan lain yang mengaku sebagai jalur pendaftaran.

**Apakah ada biaya pendaftaran CPNS?**
Tidak ada. Seluruh proses pendaftaran gratis. Waspadai pungutan, "jasa calo", atau iming-iming kelulusan.
...
*Sumber resmi: [SSCASN BKN](https://sscasn.bkn.go.id) (dicek 1 September 2026), [BKN](https://www.bkn.go.id), [KemenPAN-RB](https://www.menpan.go.id), dan PermenPAN-RB Nomor 6 Tahun 2024 tentang Pengadaan Pegawai ASN (JDIH KemenPAN-RB).*
